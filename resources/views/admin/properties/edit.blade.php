    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        <form action="{{ route('admin.properties.update', $property->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-6 space-y-2">
                ...
                <textarea name="description" rows="4" class="w-full px-4 py-2 border border-slate-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-400" placeholder="Tuliskan detail unit di sini...">{{ old('description', $property->description) }}</textarea>
            </div>
